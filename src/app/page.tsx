                            ...
                            <div className="mt-4">
                                ...
                                >
                                    {selectedProduct.variants.map(variant => (
                                        <Label key={variant.size} htmlFor={`dialog-${variant.size}`} className="flex items-center justify-center gap-2 border rounded-md p-2 px-3 cursor-pointer hover:bg-muted/50 has-[:checked]:bg-muted has-[:checked]:border-primary">
