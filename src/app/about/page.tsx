        ...
        <div className="bg-background">
            ...
            <section className="relative h-[50vh] w-full flex items-center justify-center text-white">
                <Image
                    ...
                    alt="Artisans working on handicrafts"
                    fill
                ...
                <Card className="max-w-4xl mx-auto overflow-hidden shadow-lg border-none bg-card">
                    <div className="md:flex">
                        ...
                        <div className="md:w-1/2 relative min-h-[250px] md:min-h-0">
                           <Image src="https://picsum.photos/seed/village/600/400" alt="Village of Barkulhati" fill className="object-cover" data-ai-hint="indian village" />
                        </div>
                    </div>
                </Card>

                <div className="max-w-4xl mx-auto my-12 sm:my-16">
                    <div className="md:flex flex-row-reverse items-center gap-8">
                        ...
                        <div className="md:w-1/2">
                           <div className="relative aspect-square rounded-lg overflow-hidden shadow-lg">
                                <Image src="https://picsum.photos/seed/founders/600/600" alt="Founders of Purbanchal Hasta Udyog" fill className="object-cover" data-ai-hint="artisan portrait" />
                           </div>
                        </div>
                    </div>
                </div>
                 ...
                 <Card className="max-w-4xl mx-auto overflow-hidden shadow-lg border-none bg-card">
                    <div className="md:flex">
                        ...
                        <div className="md:w-1/2 relative min-h-[250px] md:min-h-0">
                           <Image src="https://picsum.photos/seed/products/600/400" alt="Handcrafted products" fill className="object-cover" data-ai-hint="jute bags" />
                        </div>
                    </div>
                </Card>
