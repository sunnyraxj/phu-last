...
export function FloatingWhatsAppButton() {
    ...
    const templates = [
        ...
        },
        {
            icon: ShoppingBasket,
            title: 'Bulk Order',
            message: `Hello, I'm interested in placing a bulk order.${baseMessage}`
        },
        {
            icon: Sparkles,
            title: 'Custom Order',
            ...
            <PopoverContent className="w-80 mr-4 mb-2" side="top" align="end">
                <div className="grid gap-4">
                    <div className="space-y-2">
                        <h4 className="font-medium leading-none">Hello!</h4>
