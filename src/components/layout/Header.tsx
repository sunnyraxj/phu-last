      ...
      <div className="container flex h-16 items-center">
            ...
            {navLinks.map((link) =>
              link.dropdown ? (
                <DropdownMenu key={link.href}>
                  ...
                  <DropdownMenuContent className="bg-primary text-primary-foreground border-border">
        ...
        <div className="lg:hidden">
          <Sheet>
            ...
            <SheetContent side="left" className="pr-0 bg-primary text-primary-foreground border-border">
